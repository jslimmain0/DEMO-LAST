 ...
 *
 * GitHub 로그인 모드에서는 [com.flowlink.security.TenantClaimFilter] 가 JWT 테넌트 클레임으로 채우고,
 * 비동기 워커 스레드에서는 ExecutionService 가 수동으로 set/clear 한다. dev 모드(github-enabled 미설정)는
