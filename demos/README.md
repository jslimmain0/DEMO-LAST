...
> 그와 별개로 FlowLink 에는 **내장 Mock 서버 기능**(상단 "Mock 서버" 탭 — 저장 즉시 `/mock/{slug}/**` 서빙)이 있고,
> 그걸 대상으로 하는 결제 시나리오 14종은 [`pg/`](pg/README.md) 폴더에 있다. 미완성 시스템을 UI 에서 바로 mock 으로 세우려면 내장 기능을 쓰면 된다.
